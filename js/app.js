...
import { config, login, student, onCloudStatus, sheetLog, todayCode,
         ...
         checkAdminPin, setDemoAccount } from './state.js?v=30';
import { initCase, refreshFromWork } from './case3d.js?v=30';
import { initCircuit, refreshCircuit } from './circuit.js?v=30';
import { initDesign, refreshDesign } from './design.js?v=30';
import { initAssembly, refreshAssembly } from './assembly.js?v=30';
import { initPreview, drawPreview } from './preview.js?v=30';
import { initFaq } from './faq.js?v=30';
import { initAdmin, openAdmin } from './admin.js?v=30';
...
import * as state from './state.js?v=30';
window.__lps = state;
