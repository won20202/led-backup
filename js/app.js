...
import { config, login, student, onCloudStatus, sheetLog, todayCode,
         ...
         checkAdminPin, setDemoAccount } from './state.js?v=35';
import { initCase, refreshFromWork } from './case3d.js?v=35';
import { initCircuit, refreshCircuit } from './circuit.js?v=35';
import { initDesign, refreshDesign } from './design.js?v=35';
import { initAssembly, refreshAssembly } from './assembly.js?v=35';
import { initPreview, drawPreview } from './preview.js?v=35';
import { initFaq } from './faq.js?v=35';
import { initAdmin, openAdmin } from './admin.js?v=35';
...
import * as state from './state.js?v=35';
window.__lps = state;
