...
import { config, login, student, onCloudStatus, sheetLog, todayCode,
         ...
         checkAdminPin, setDemoAccount } from './state.js?v=56';
import { initCase, refreshFromWork } from './case3d.js?v=56';
import { initCircuit, refreshCircuit } from './circuit.js?v=56';
import { initDesign, refreshDesign } from './design.js?v=56';
import { initAssembly, refreshAssembly } from './assembly.js?v=56';
import { initPreview, drawPreview } from './preview.js?v=56';
import { initFaq } from './faq.js?v=56';
import { initAdmin, openAdmin } from './admin.js?v=56';
...
import * as state from './state.js?v=56';
window.__lps = state;
