...
import { config, login, student, onCloudStatus, sheetLog, todayCode,
         ...
         checkAdminPin, setDemoAccount } from './state.js?v=45';
import { initCase, refreshFromWork } from './case3d.js?v=45';
import { initCircuit, refreshCircuit } from './circuit.js?v=45';
import { initDesign, refreshDesign } from './design.js?v=45';
import { initAssembly, refreshAssembly } from './assembly.js?v=45';
import { initPreview, drawPreview } from './preview.js?v=45';
import { initFaq } from './faq.js?v=45';
import { initAdmin, openAdmin } from './admin.js?v=45';
...
import * as state from './state.js?v=45';
window.__lps = state;
