...
import { config, login, student, onCloudStatus, sheetLog, todayCode,
         ...
         checkAdminPin, setDemoAccount } from './state.js?v=28';
import { initCase, refreshFromWork } from './case3d.js?v=28';
import { initCircuit, refreshCircuit } from './circuit.js?v=28';
import { initDesign, refreshDesign } from './design.js?v=28';
import { initAssembly, refreshAssembly } from './assembly.js?v=28';
import { initPreview, drawPreview } from './preview.js?v=28';
import { initFaq } from './faq.js?v=28';
import { initAdmin, openAdmin } from './admin.js?v=28';
...
import * as state from './state.js?v=28';
window.__lps = state;
