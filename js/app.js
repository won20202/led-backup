...
import { config, login, student, onCloudStatus, sheetLog, todayCode,
         ...
         checkAdminPin, setDemoAccount } from './state.js?v=52';
import { initCase, refreshFromWork } from './case3d.js?v=52';
import { initCircuit, refreshCircuit } from './circuit.js?v=52';
import { initDesign, refreshDesign } from './design.js?v=52';
import { initAssembly, refreshAssembly } from './assembly.js?v=52';
import { initPreview, drawPreview } from './preview.js?v=52';
import { initFaq } from './faq.js?v=52';
import { initAdmin, openAdmin } from './admin.js?v=52';
...
import * as state from './state.js?v=52';
window.__lps = state;
