...
import { config, login, student, onCloudStatus, sheetLog, todayCode,
         ...
         checkAdminPin, setDemoAccount } from './state.js?v=59';
import { initCase, refreshFromWork } from './case3d.js?v=59';
import { initCircuit, refreshCircuit } from './circuit.js?v=59';
import { initDesign, refreshDesign } from './design.js?v=59';
import { initAssembly, refreshAssembly } from './assembly.js?v=59';
import { initPreview, drawPreview } from './preview.js?v=59';
import { initFaq } from './faq.js?v=59';
import { initAdmin, openAdmin } from './admin.js?v=59';
...
import * as state from './state.js?v=59';
window.__lps = state;
