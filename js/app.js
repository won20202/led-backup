...
import { config, login, student, onCloudStatus, sheetLog, todayCode,
         ...
         checkAdminPin, setDemoAccount } from './state.js?v=36';
import { initCase, refreshFromWork } from './case3d.js?v=36';
import { initCircuit, refreshCircuit } from './circuit.js?v=36';
import { initDesign, refreshDesign } from './design.js?v=36';
import { initAssembly, refreshAssembly } from './assembly.js?v=36';
import { initPreview, drawPreview } from './preview.js?v=36';
import { initFaq } from './faq.js?v=36';
import { initAdmin, openAdmin } from './admin.js?v=36';
...
import * as state from './state.js?v=36';
window.__lps = state;
