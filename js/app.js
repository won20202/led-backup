...
import { config, login, student, onCloudStatus, sheetLog, todayCode,
         ...
         checkAdminPin, setDemoAccount } from './state.js?v=37';
import { initCase, refreshFromWork } from './case3d.js?v=37';
import { initCircuit, refreshCircuit } from './circuit.js?v=37';
import { initDesign, refreshDesign } from './design.js?v=37';
import { initAssembly, refreshAssembly } from './assembly.js?v=37';
import { initPreview, drawPreview } from './preview.js?v=37';
import { initFaq } from './faq.js?v=37';
import { initAdmin, openAdmin } from './admin.js?v=37';
...
import * as state from './state.js?v=37';
window.__lps = state;
