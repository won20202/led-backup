...
import { config, login, student, onCloudStatus, sheetLog, todayCode,
         ...
         checkAdminPin, setDemoAccount } from './state.js?v=47';
import { initCase, refreshFromWork } from './case3d.js?v=47';
import { initCircuit, refreshCircuit } from './circuit.js?v=47';
import { initDesign, refreshDesign } from './design.js?v=47';
import { initAssembly, refreshAssembly } from './assembly.js?v=47';
import { initPreview, drawPreview } from './preview.js?v=47';
import { initFaq } from './faq.js?v=47';
import { initAdmin, openAdmin } from './admin.js?v=47';
