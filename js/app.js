...
import { config, login, student, onCloudStatus, sheetLog, todayCode,
         ...
         checkAdminPin, setDemoAccount } from './state.js?v=38';
import { initCase, refreshFromWork } from './case3d.js?v=38';
import { initCircuit, refreshCircuit } from './circuit.js?v=38';
import { initDesign, refreshDesign } from './design.js?v=38';
import { initAssembly, refreshAssembly } from './assembly.js?v=38';
import { initPreview, drawPreview } from './preview.js?v=38';
import { initFaq } from './faq.js?v=38';
import { initAdmin, openAdmin } from './admin.js?v=38';
...
import * as state from './state.js?v=38';
window.__lps = state;
